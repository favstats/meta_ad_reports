...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1701510278);
user_pref("app.update.lastUpdateTime.background-update-timer", 1701510278);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1701510466);
user_pref("app.update.lastUpdateTime.region-update-timer", 1701510278);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1701510278);
...
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1701510278);
...
user_pref("media.gmp-manager.lastCheck", 1701512099);
user_pref("media.gmp-manager.lastEmptyCheck", 1701512099);
...
user_pref("toolkit.startup.last_success", 1701511939);
